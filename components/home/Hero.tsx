...
function Hero() {
  return (
    <>
      ...
      >
        <p className="text-2xl mb-5 font-bold">Hey! I’m Koushik</p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
          ...
          games. */}
          A <span className="heroShiny2 text-fun-pink">game developer</span> who loves turning ideas into <span className="heroShiny2 text-fun-pink">interactive</span> fun. If it’s got a story, or a challenge… I’m in! 🚀
          {/* <img
          ...
          />
          <img
  className="sqD squiggle-hero-pop2 hidden sm:block sm:top-[-130px] sm:right-[15%] lg:top-[-130px] lg:right-[120px]"
