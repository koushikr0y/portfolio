...
export const skills: Skill[] = [
  ...
  {
    title: "Photon Fusion",
    icon: "https://www.pgconnects.com/digital/wp-content/uploads/sites/12/2020/04/logo-Photon-300x.png", // Clean Photon Fusion logo on dark
  },
  // {
  //   title: "AR.js",
  //   icon: "https://upload.wikimedia.org/wikipedia/commons/7/75/ARjs_logo.png",
  // },
  // {
  //   title: "8thWall",
  //   icon: "https://avatars.githubusercontent.com/u/29712236?s=200&v=4",
  // },
  // // {
  //   title: "Sass",
